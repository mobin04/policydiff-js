...
export type JobErrorType = 'INVALID_URL' | 'FETCH_ERROR' | 'HTTP_ERROR' | 'TIMEOUT' | 'DNS_FAILURE' | 'CONNECTION_ERROR' | 'INTERNAL_ERROR' | 'CRASH_RECOVERY' | 'JOB_TIMEOUT' | 'UNSUPPORTED_DYNAMIC_PAGE' | 'PAGE_ACCESS_BLOCKED' | 'INVALID_PAGE_CONTENT';
